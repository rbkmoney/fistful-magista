...
public class WalletData extends TableImpl<WalletDataRecord> {
    ...
    private static final long serialVersionUID = 1855983191;
    ...
    /**
     * The column <code>mst.wallet_data.party_id</code>.
     */
    public final TableField<WalletDataRecord, UUID> PARTY_ID = createField("party_id", org.jooq.impl.SQLDataType.UUID, this, "");

    /**
     * The column <code>mst.wallet_data.identity_id</code>.
     */
    public final TableField<WalletDataRecord, String> IDENTITY_ID = createField("identity_id", org.jooq.impl.SQLDataType.VARCHAR, this, "");
