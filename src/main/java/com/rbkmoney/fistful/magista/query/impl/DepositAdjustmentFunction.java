...
public class DepositAdjustmentFunction extends PagedBaseFunction<Map.Entry<Long, StatDepositAdjustment>, StatResponse>
    ...
    public static DepositAdjustmentFunction createFunction(Object descriptor, QueryParameters queryParameters,
                                                           String continuationToken,
                                                           CompositeQuery<QueryResult, List<QueryResult>> subquery) {
        DepositAdjustmentFunction func =
                new DepositAdjustmentFunction(descriptor, queryParameters, continuationToken, subquery);
    ...
    private DepositAdjustmentFunction(Object descriptor, QueryParameters params, String continuationToken,
                                      CompositeQuery<QueryResult, List<QueryResult>> subquery) {
