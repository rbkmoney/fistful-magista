...
public class DepositAdjustmentDataFunction extends PagedBaseFunction<Map.Entry<Long, StatDepositAdjustment>, Collection<Map.Entry<Long, StatDepositAdjustment>>> {
    ...
    @Override
    public QueryResult<Map.Entry<Long, StatDepositAdjustment>, Collection<Map.Entry<Long, StatDepositAdjustment>>> execute(QueryContext context) throws QueryExecutionException {
