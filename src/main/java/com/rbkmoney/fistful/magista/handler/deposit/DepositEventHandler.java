...
public interface DepositEventHandler extends EventHandler<TimestampedChange, MachineEvent> {
    ...
    default void initEventFields(DepositData depositData, long eventId, LocalDateTime eventCreatedAt, LocalDateTime eventOccuredAt, DepositEventType eventType) {
    ...
    default void initEventFields(DepositAdjustmentData depositAdjustmentData, long eventId, LocalDateTime eventCreatedAt, LocalDateTime eventOccuredAt, DepositAdjustmentDataEventType eventType) {
    ...
    default void initEventFields(DepositRevertData depositRevertData, long eventId, LocalDateTime eventCreatedAt, LocalDateTime eventOccuredAt, DepositRevertDataEventType eventType) {
