...
public class WithdrawalStatusChangedEventHandler implements WithdrawalEventHandler {
    ...
    public void handle(TimestampedChange change, MachineEvent event) {
        try {
            ...
            log.info("Trying to handle WithdrawalStatusChanged: eventId={}, withdrawalId={}", event.getEventId(), event.getSourceId());
            ...
            log.info("WithdrawalStatusChanged has been saved: eventId={}, withdrawalId={}", event.getEventId(), event.getSourceId());
    ...
    private WithdrawalData getWithdrawalData(MachineEvent event) throws DaoException {
        ...
        if (withdrawalData == null) {
            throw new NotFoundException(String.format("WithdrawalEvent with withdrawalId='%s' not found", event.getSourceId()));
        }
